...
const HelpController = (menuController, rootElt) => {
    ...
    const handleKeyBoard = ({ ctrlKey, key }) => { 
        ...
        if(ctrlKey&&key=='A') {
            ...
            menuController.section(menuProperties.SECTION_ADMIN).state.setValue(state==menuProperties.STATE_VISIBLE?menuProperties.STATE_HIDDEN:menuProperties.STATE_VISIBLE);   
        };    
    };
